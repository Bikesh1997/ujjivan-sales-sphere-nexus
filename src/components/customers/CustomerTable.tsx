            ...
            <Table>
              ...
              <TableBody>
                {currentCustomers.map((customer, index) => {
                  // Show star for first 3 customers in the entire filtered list
                  const originalIndex = filteredCustomers.findIndex(c => c.key === customer.key);
                  const showStar = originalIndex < 3;
